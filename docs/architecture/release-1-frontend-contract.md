...
`/api/auth/current` now expose `accountId`, the string form of the generated,
non-recycled user primary key. FE-28, FE-29, and FE-30 persist that value and require
